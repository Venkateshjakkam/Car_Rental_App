        ...
        <Row>
          ...
          <Col lg="3" md="4" sm="6">
            <div className="mb-4">
              ...
              <p className="office__info">123,Opp Vinod Metro, Delhi, India</p>
              <p className="office__info">Phone: +91-95345875365</p>

              <p className="office__info">Email: CRS_help@gmail.com</p>
